...
- Tickets has been moved to the web component repository https://github.com/vaadin/vaadin-split-layout/issues
...
- `mvn -pl vaadin-split-layout-flow-demo -Pwar install jetty:run`
