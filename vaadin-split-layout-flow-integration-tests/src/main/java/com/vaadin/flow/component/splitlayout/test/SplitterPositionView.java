...
public class SplitterPositionView extends Div {
    ...
    public final static double initialPosition = 70;
    public final static double finalPosition = 30;
    ...
    private void createLayoutJavaApi() {
        ...
        layout.setSplitterPosition(initialPosition);
        layout.setId("splitLayoutJavaApi");
        NativeButton setSplitterPosition = new NativeButton(
                "set splitter position",
                event -> layout.setSplitterPosition(finalPosition));
